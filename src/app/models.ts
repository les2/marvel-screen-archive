...
export interface Character { id:string; name:string; aliases:string[]; description?:string; catalogSummary?:string; descriptionSource?:'ai-assisted'; universeIds?:string[]; appearanceCount?:number; firstAppearanceId?:string; latestAppearanceId?:string; primaryRole?:RoleType; comicOrigin?:'confirmed'|'probable'|'screen-original'|'unclassified'; profileConfidence?:'curated'|'inferred'; profileStatus?:'researched'|'screen-credit-only'; characterType?:'hero'|'villain'|'antihero'|'civilian'|'cosmic-being'|'deity'|'android'|'creature'|'unknown'; alignment?:'heroic'|'villainous'|'antihero'|'neutral'|'varies'|'unknown'; powerStatus?:'powered'|'non-powered'|'technology-assisted'|'magic-user'|'cosmic'|'varies'|'unknown'; powers?:string[]; skills?:string[]; affiliations?:string[]; sourceIds?:string[]; performerIds?:string[]; officialUrl?:string; wikipediaUrl?:string; artworkUrl?:string; }
