...
export class AppComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    try {
      const { titles, universes, characters, collections, sagas, phases, storyArcs } = await this.data.load();
      this.titles.set(titles); this.universes.set(universes); this.characters.set(characters); this.collections.set(collections); this.sagas.set(sagas); this.phases.set(phases); this.storyArcs.set(storyArcs);
