...
const characters:Character[] = [
  {id:'peter',name:'Peter Parker',aliases:['Spider-Man'],description:'A friendly neighborhood hero.',universeIds:['mcu'],appearanceCount:2,firstAppearanceId:'civil-war',latestAppearanceId:'no-way-home',primaryRole:'lead',comicOrigin:'confirmed'},
